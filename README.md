...
Aplikasi berbasis web untuk mengelola absensi dan monitoring penugasan siswa PKL dari berbagai sekolah SMK. Dibangun menggunakan **Laravel 12** dan **Bootstrap 5**, serta dioptimalkan agar enteng saat di-deploy di shared hosting gratisan seperti InfinityFree.
...
### 🎓 Fitur Siswa (Anak PKL)
* **Upload Bukti Tugas:** Halaman dashboard untuk mengirimkan file gambar bukti pengerjaan tugas.
* **Auto-Lock Sistem:** Tombol upload otomatis terkunci dari sisi backend jika waktu pengumpulan sudah melewati *due date* yang ditentukan admin.
...
4. **Setel konfigurasi database di file .env, lalu jalankan migrasi beserta seeders: **
```bash
php artisan migrate --seed

4. **Bersihkan cache rute lalu nyalakan server lokal: **
```bash
php artisan route:clear
php artisan serve


**Fredy Dwi Saputra @ 2026**
